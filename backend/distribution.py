...
def best_fit_distribution(data, bins=200):
    ...
    DISTRIBUTIONS = [
        ...
        stats.exponweib, stats.exponpow, stats.f, stats.fatiguelife, stats.foldcauchy, stats.foldnorm, stats.frechet_r,
        stats.frechet_l, stats.genlogistic, stats.genpareto, stats.gennorm, stats.genexpon, stats.genextreme,
...
if __name__ == "__main__":
    ...
    test = rule_params['distribution']['test_type']
